//@ts-nocheck
import { CanvasLike, OffscreenCanvasCreator } from '..';
...
export class TextService {
  constructor(private offscreenCanvas:OffscreenCanvasCreator) {}
  ...
  measureFont(font: string, offscreenCanvas: CanvasLike): IFontMetrics {
    ...
    const canvas =
      this.offscreenCanvas.getOrCreateCanvas(offscreenCanvas);
    const context =
      this.offscreenCanvas.getOrCreateContext(offscreenCanvas);
