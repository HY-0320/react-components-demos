...
import { findClosestClipPathTarget, Point } from '../g-lite';
import { offscreenCanvas } from '../g-lite/globalContants/textConstants';
...
export class CanvasPickerPlugin implements RenderingPlugin {
  ...
  private isPointInPath = (
    ...
    const context = offscreenCanvas.getOrCreateContext(
