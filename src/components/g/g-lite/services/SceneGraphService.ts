...
import { findClosestClipPathTarget } from '../utils/dom';
...
export class DefaultSceneGraphService implements SceneGraphService {
  ...
  constructor(private sceneGraphSelector:SceneGraphSelector) {}

  matches<T extends IElement>(query: string, root: T) {
    return this.sceneGraphSelector.is(query, root);
  }
  ...
  querySelector<R extends IElement, T extends IElement>(
    ...
    return this.sceneGraphSelector.selectOne<R, T>(query, root);
  }
  ...
  querySelectorAll<R extends IElement, T extends IElement>(
    ...
    return this.sceneGraphSelector.selectAll<R, T>(query, root);
