...
import { convertAngleUnit } from '../css/parser/dimension';
import { Odeg, Opx } from '../css/cssom/CSSNumericValue';
import type { ParsedTransform } from '../css/parser/transform';
import type { Tuple3Number } from '../types';
